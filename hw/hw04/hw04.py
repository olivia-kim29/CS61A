...
def replace_leaf(t, old, new):
    ...
    if is_leaf(t) and label(t) == old:
        ...
        a = [replace_leaf(b, old, new) for b in branches(t)]
...
def prune_leaves(t, vals):
    ...
    if label(t) in vals and is_leaf(t):
        ...
        a = [prune_leaves(b, vals) for b in branches(t) if is_tree(prune_leaves(b, vals))]
        return tree(label(t), a)
...
Torque of the left side is the length of the left rod multiplied by the total weight hanging from that rod.
...
def totals_tree(m):
    ...
    if is_weight(m):
        ...
        t = [totals_tree(end(left(m))), totals_tree(end(right(m)))]
        return tree(total_weight(m), t)
###################
# Extra Questions #
###################
