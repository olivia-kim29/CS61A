...
def make_withdraw(balance, password):
    ...
    def withdraw(amount, attempted_password):
        ...
        if password == attempted_password:
            ...
            attempts.append(attempted_password)
...
def make_joint(withdraw, old_password, new_password):
    ...
    def joint(money, newPassword):
        if newPassword == new_password:
            return withdraw(money, old_password)
        else:
            return withdraw(money, newPassword)
    return joint
